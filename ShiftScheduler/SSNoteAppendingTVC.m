//
//  SSNoteAppendingTVC.m
//  ShiftScheduler
//
//  Created by Jiejing Zhang on 15/7/6.
//
//

#import "SSNoteAppendingTVC.h"

@interface SSNoteAppendingTVC ()

@end

@implementation SSNoteAppendingTVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"NoteAddingCell"];
    
    if (!cell) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewStylePlain reuseIdentifier:@"NoteAddingCell"];
    }
    // Configure the cell...
