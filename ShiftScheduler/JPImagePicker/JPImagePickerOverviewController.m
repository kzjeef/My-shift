...
#define PADDING 40  // 这些ICON都很小，所以Padding弄大一点， 图像弄小一点
// define PADDING 4
#define THUMBNAIL_COLS 4


#define NOT_ENABLE_DETAIL_CONTROLLER
...
#ifdef NOT_ENABLE_DETAIL_CONTROLLER
    [self.imagePickerController.delegate imagePicker:self.imagePickerController didFinishPickingWithImageNumber:sender.tag];
#else
